...
import { formatHijriFromISO } from "@/lib/hijri"; // ⬅️ add this
...
export default async function PersonPage({ params }: { params: { id: string } }) {
  ...
  // --- New: compute Hijri from Gregorian if available ---
  ...
  // Prefer calculated values; fall back to stored fields if present
